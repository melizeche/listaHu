...
class DenunciaForm(ModelForm):
	numero = forms.CharField(
		min_length=10, max_length=14, error_messages=error_numero,
		widget=forms.TextInput(attrs={'style': 'width:90%', 'placeholder':'0981XXXXXX','class':'pure-form'}),
	...
	screenshot = forms.ImageField(error_messages=error_screen, 
		widget=forms.FileInput(attrs={'style': 'width:100%'}), 
